  ...
  return (
    <><AnimatePresence>
      {open ? (
        ...
        <PhoneHeader key="phone-header" initial = {{height:0, opacity:0}} animate={{height:'100vh', opacity:1}} transition={{duration:0.5}} exit={{height:0, opacity:0}}>
        ...
        <i onClick={toggleMenu} class="fa-solid fa-x"></i>
      </PhoneHeader>
